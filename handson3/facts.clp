(deffacts clientes
   	(cliente (cliente-id 1)(nombre Juan)(edad 30)(celular 3331234567)(sexo M)(direccion  Calle Principal 123 ))
   	(cliente (cliente-id 2)(nombre Ana)(edad 25)(celular 3319876543)(sexo F)(direccion  Avenida Central 456 ))
   	(cliente (cliente-id 3)(nombre Villelon)(edad 28)(celular 3323456789)(sexo NA)(direccion  Calle Secundaria 789 ))
   	(cliente (cliente-id 4)(nombre María)(edad 35)(celular 3348765432)(sexo F)(direccion  Avenida Secundaria 321 ))
   	(cliente (cliente-id 5)(nombre Luis)(edad 32)(celular 3300012345)(sexo NA)(direccion Calle Norte 111))
   	(cliente (cliente-id 6)(nombre Laura)(edad 27)(celular 3367890123)(sexo F)(direccion Avenida Sur 654))
   	(cliente (cliente-id 7)(nombre Pedro)(edad 22)(celular 3322345678)(sexo M)(direccion Calle Este 999))
   	(cliente (cliente-id 8)(nombre Elena)(edad 29)(celular 3312345670)(sexo NA)(direccion Avenida Oeste 777))
   	(cliente (cliente-id 9)(nombre Javier)(edad 40)(celular 3354321567)(sexo M)(direccion Calle Peatonal 888))
   	(cliente (cliente-id 10)(nombre Sofía)(edad 26)(celular 3343215678)(sexo F)(direccion Avenida Principal 555))
   	(cliente (cliente-id 11)(nombre Vidal)(edad 21)(celular 3366666666)(sexo M)(direccion Calle Nueva 111))
   	(cliente (cliente-id 12)(nombre Yoni)(edad 30)(celular 3377777777)(sexo NA)(direccion Avenida Nueva 222))		
)
...
(deffacts celulares
   	...
   	(smartphone (smartphone-id 2) (marca  Apple)(modelo  "iPhone 13")(precio 11000)(almacenamiento 128gb)(bateria 4000mAh)(peso 168)(color Negro))
   	...
   	(smartphone (smartphone-id 4) (marca  Sony)(modelo  "Xperia 5")(precio 15000)(almacenamiento 256gb )(bateria 4200mAh)(peso 163)(color Rojo))
...
(deffacts computadoras
	(computador (computador-id 1) (marca HP )(modelo "Laptop Envy")(precio 15000)(so  "Windows 11")(almacenamiento 512gb)(bateria 8h)(peso 2.5)(color Plateado))
   	(computador (computador-id 2) (marca Dell )(modelo "XPS 13")(precio 20000)(so  "Windows 11")(almacenamiento 1tb )(bateria 10h)(peso 2.7)(color Negro))
   	(computador (computador-id 3) (marca Lenovo )(modelo "ThinkPad X1 Carbon")(precio 8000)(so  "Windows 11")(almacenamiento 512gb)(bateria 9h)(peso 2.4)(color Gris))
   	(computador (computador-id 4) (marca Acer )(modelo "Predator Helios")(precio 26000)(so  "Windows 11")(almacenamiento 1tb)(bateria  6h)(peso 2.8)(color  Rojo))
)

(deffacts accesorios
	(accesorio (accesorio-id 1) (marca Logitech)(modelo  "Teclado G Pro X")(precio 899)(color  Negro ))
	(accesorio (accesorio-id 2) (marca Razer)(modelo  "Ratón Naga X")(precio 599)(color  Negro ))
	(accesorio (accesorio-id 3) (marca Bose)(modelo  "Auriculares QuietComfort 45")(precio 349)(color  Blanco ))
	(accesorio (accesorio-id 4) (marca Samsung)(modelo "Monitor Odyssey G9")(precio 1599)(color  Plateado ))
	(accesorio (accesorio-id 5) (marca Corsair)(modelo  "SSD MP600 Pro")(precio 299)(color  Negro ))
)
